							...
							<div class="card-body">
								<form method="POST" action="<?= base_url('pemesan/proses_ubah/' . $pemesan->id) ?>" enctype="multipart/form-data">
									  ...
									  <div class="form-group">
								  		...
								  		<input type="text" value="<?= $pemesan->nama ?>" name="no_sim" id="no_sim" required="required" placeholder="ketik" autocomplete="off" class="form-control">
								  	</div>

									  <div class="form-group">
								  		<label for="nama">No. HP</label>
								  		<input type="text" value="<?= $pemesan->nama ?>" name="no_hp" id="no_hp" required="required" placeholder="ketik" autocomplete="off" class="form-control">
								  	</div>
