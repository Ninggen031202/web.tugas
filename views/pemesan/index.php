							...
							<div class="card-body">
								<form method="POST" action="<?= base_url('pemesan/tambah') ?>" enctype="multipart/form-data">
									  ...
									  <div class="form-group">
								  		...
								  		<input type="text" name="no_sim" id="no_sim" required="required" placeholder="ketik" autocomplete="off" class="form-control">
								  	</div>

									  <div class="form-group">
								  		<label for="nama">No. HP</label>
								  		<input type="text" name="no_hp" id="no_hp" required="required" placeholder="ketik" autocomplete="off" class="form-control">
								  	</div>
